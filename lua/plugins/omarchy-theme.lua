local supported_themes = {
    ...
    monokai =    { "gthelding/monokai-pro.nvim", name = "monokai-pro", lazy = true },
}
...
-- Watch for changes to the omarchy theme directory symlink to update the theme dynamically
...
return table_values(supported_themes)
